...
@section('title', 'Quản lý ngành nghề')
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
        ...
        <div>
            ...
            <p class="text-muted mb-0">
                ...
                Quản lý danh sách ngành nghề tuyển dụng trên hệ thống JobConnect
            ...
            <div class="stats-card">
                ...
                <div>
                    ...
                    <h3 class="stats-number text-success">
                        ...
                        {{ \App\Models\Category::has('jobs')->count() }}
            ...
            <div class="stats-card">
                ...
                <div>
                    ...
                    <h3 class="stats-number text-warning">
                        ...
                        {{ \App\Models\Category::doesntHave('jobs')->count() }}
                            ...
                            <td>
                                ...
                                @if($category->applications_count > 0)
                                    ...
                                    <span class="jobs-badge active">
                                        ...
                                        {{ $category->applications_count }} apply
                                ...
                                <div class="d-flex gap-2">
                                    ...
                                    <form action="/admin/categories/{{ $category->id }}"
                                        ...
                                        <button class="action-btn danger"
                                                onclick="return confirm('Xóa ngành nghề này?')">
                            ...
                            <td colspan="5">
                                ...
                                <div class="empty-state">
                                    ...
                                    <p>
                                        ...
                                        Hệ thống chưa có dữ liệu ngành nghề
